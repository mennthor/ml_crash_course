    ...
    \begin{columns}
      \begin{column}{0.65\textwidth}
        \begin{itemize}
          ...
          % \item The most simple network architectures only contain \enquote{fully connected} layers, meaning a straightforward chain of linear transformations and activations
          \item \small\url{https://scikit-learn.org/stable/modules/generated/sklearn.tree.DecisionTreeClassifier.html}
        \end{itemize}
        \vspace{-0.5em}
        \begin{mdframed}
      ...
      \begin{column}{0.35\textwidth}
        ...
        \includegraphics[width=0.9\textwidth]{02-img-algos_nn_classification}
      \end{column}
    \end{columns}
  \end{frame}

  \begin{frame}[fragile]{Simple Fully-Connected Neural Network Regression}
    \begin{columns}
      \begin{column}{0.65\textwidth}
        \begin{itemize}
      ...
      \begin{column}{0.35\textwidth}
        ...
        \includegraphics[width=0.9\textwidth]{02-img-algos_nn_regression}
      \end{column}
    \end{columns}
  \end{frame}
